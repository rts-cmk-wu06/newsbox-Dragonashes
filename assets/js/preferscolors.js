...
// otherwise i can use <noscript>

/**
 * A shared method for setting the button text label and visually hidden status element
*/
// const setButtonLabelAndStatus = currentSetting => {
//   document.querySelector('.js-mode-toggle-text').innerText = `Enable ${currentSetting === 'dark' ? 'light' : 'dark'} mode`;
//   document.querySelector('.js-mode-status').innerText = `Color mode is now "${currentSetting}"`;
// }
/**
 ...
 */
document.querySelector('.js-mode-toggle').addEventListener('click', evt => {
  evt.preventDefault();
